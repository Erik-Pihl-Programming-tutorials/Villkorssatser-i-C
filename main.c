/********************************************************************************
* main.c: Demonstration av villkorssatser i C.
* 
...
*         är sant används så kallade loopar, primärt via while primärt if-else satsen, 
*         som möjliggör att ett flertal olika villkor kan testas och implementeras.
* 
...
/********************************************************************************
* main: Implementerar en temperaturregulator, som reglerar temperaturen till
*       25 grader ifall temperaturen överstiger eller är lika med 30 grader
*       eller ifall den understiger eller är lika med 20 grader. 
*       Temperaturregulatorn körs fem gånger.
********************************************************************************/
int main(void)
{
   int temp = 0;
